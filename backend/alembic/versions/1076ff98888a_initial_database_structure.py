...
Revision ID: 1076ff98888a
Revises: 55572dc1e1fb
Create Date: 2025-03-19 23:39:31.899374
...
revision: str = '1076ff98888a'
down_revision: Union[str, None] = '55572dc1e1fb'
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('user', 'admin', 'moderator', name='user_role', create_constraint=True), nullable=True),
    sa.Column('account_status', sa.Enum('active', 'suspended', 'deleted', name='account_status', create_constraint=True), nullable=True),
    sa.Column('profile_visibility', sa.Enum('public', 'private', 'friends_only', name='profile_visibility', create_constraint=True), nullable=True),
