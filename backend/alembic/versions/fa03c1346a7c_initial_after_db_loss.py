"""Initial after DB loss

Revision ID: fa03c1346a7c
Revises: 4386c04e916c
Create Date: 2025-03-23 15:09:59.879797
...
revision: str = 'fa03c1346a7c'
down_revision: Union[str, None] = '4386c04e916c'
...
def upgrade() -> None:
    ...
    sa.Column('reset_code', sa.String(length=8), nullable=False),
    ...
    sa.Column('likes_status', sa.Enum('PUBLIC', 'PRIVATE', 'FRIENDS_ONLY', name='visibility_option'), nullable=False),
    sa.Column('comment_status', sa.Enum('PUBLIC', 'PRIVATE', 'FRIENDS_ONLY', name='visibility_option'), nullable=False),
    sa.Column('addit_file_status', sa.Enum('PUBLIC', 'PRIVATE', 'FRIENDS_ONLY', name='visibility_option'), nullable=False),
